...
def _nodes(context):
    ...
    return [
        Node(
            ...
            name="uto_planner",
            output="screen",
            parameters=[os.path.join(share, "config", f"uto_{mode}.yaml")],
        ),
        Node(
            package="uto_ros2",
            ...
            output="screen",
            parameters=[os.path.join(share, "config", "gazebo_harmonic_px4.yaml")],
        ),
    ]
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                ...
                description="Select matching planner YAML",
            ),
